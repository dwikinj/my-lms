...
@php
    ...
    $questionCount = App\Models\Question::where('user_id', $id)->count();
@endphp
        ...
        <div class="card card-item dashboard-info-card">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="pl-4">
                    ...
                    <h5 class="card-title pt-2 fs-26">{{$orderCount}}</h5>
                </div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div><!-- end col-lg-4 -->
    ...
    <div class="col-lg-4 responsive-column-half">
        <div class="card card-item dashboard-info-card">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="pl-4">
                    <p class="card-text fs-18">My Wishlist</p>
    ...
    <div class="col-lg-4 responsive-column-half">
        <div class="card card-item dashboard-info-card">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="pl-4">
                    <p class="card-text fs-18">Questions Total</p>
