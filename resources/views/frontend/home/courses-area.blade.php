    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs generic-tab justify-content-center pb-4" id="myTab" role="tablist">
            ...
            @foreach ($categories as $category)
                <li class="nav-item">
                    <a class="nav-link" id="design-tab" data-toggle="tab" href="#business{{$category->id}}" role="tab"
            ...
            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_{{$course->id}}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title"><a
                                                href="course-details.html">{{ $course->course_title }}</a></h5>
                                        <p class="card-text"><a
                ...
                @foreach ($categories as $category)
                    ...
                    <div class="tab-pane fade" id="business{{$category->id}}" role="tabpanel" aria-labelledby="business-tab">
                        <div class="row">
                            @php
                                $categoryWiseCourse = App\Models\Course::where('category_id',$category->id)->where('status',1)->orderBy('id','DESC')->get();
                            @endphp
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_{{$course->id}}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title"><a href="course-details.html">{{$course->course_title}}</a></h5>
    ...
    <div id="tooltip_content_{{$course->id}}">
        <div class="card card-item">
            <div class="card-body">
                ...
                <h5 class="card-title pb-1"><a href="course-details.html">{{$course->course_title}}</a></h5>
                <div class="d-flex align-items-center pb-1">
                    ...
                    <p class="text-success fs-14 font-weight-medium">Updated<span
                            class="font-weight-bold pl-1"> {{ $course->updated_at->format('F Y') }}</span></p>
                </div>
                <ul
