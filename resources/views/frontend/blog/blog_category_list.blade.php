...
@section('title')
{{$blogCategory->category_name}} | My Lms(Aduca)
@endsection
<!-- ================================
    ...
    <div class="container">
        <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
            <div class="section-heading">
                <h2 class="section__title text-white">{{$blogCategory->category_name}} Category</h2>
            </div>
            <ul class="generic-list-item generic-list-item-white generic-list-item-arrow d-flex flex-wrap align-items-center">
                <li><a href="index.html">Home</a></li>
                <li>Blog</li>
                <li>{{$blogCategory->category_name}}</li>
            </ul>
                        ...
                        <div class="card card-item">
                            <div class="card-image">
                                <a href="blog-single.html" class="d-block">
                                    <img class="card-img-top lazy" src="{{ asset($item->post_image) }}" data-src="{{ asset($item->post_image) }}" alt="Card image cap">
                                </a>
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a href="{{ route('blog.post.detail',['id' => $item->id,'slug' => $item->post_slug]) }}">{{$item->post_title}}</a></h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center pt-3">
                                    <a href="{{ route('blog.post.detail',['id' => $item->id,'slug' => $item->post_slug]) }}" class="btn theme-btn theme-btn-sm theme-btn-white">Read More <i class="la la-arrow-right icon ml-1"></i></a>
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <ul class="generic-list-item">
                                @foreach ($blogCategoryAll as $item)
                                    <li><a href="{{ route('blog.post.category.list',['id'=>$item->id]) }}">{{$item->category_name}}</a></li>
                                @endforeach
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                <a href="{{ route('blog.post.detail',['id' => $item->id,'slug' => $item->post_slug]) }}" class="media-img">
                                    <img class="mr-3" src="{{ asset($item->post_image) }}" alt="Related course image">
                                </a>
                                <div class="media-body">
                                    <h5 class="fs-15"><a href="{{ route('blog.post.detail',['id' => $item->id,'slug' => $item->post_slug]) }}">{{$item->post_title}}</a></h5>
