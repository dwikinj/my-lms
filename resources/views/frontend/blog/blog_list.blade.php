                                ...
                                <div class="card card-item">
                                    <div class="card-image">
                                        <a href="blog-single.html" class="d-block">
                                            <img class="card-img-top lazy" src="{{ asset($item->post_image) }}"
                                                data-src="{{ asset($item->post_image) }}" alt="Card image cap">
                                        </a>
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title"><a
                                                href="{{ route('blog.post.detail', ['id' => $item->id, 'slug' => $item->post_slug]) }}">{{ $item->post_title }}</a>
                                        </h5>
                                        <ul
                                        ...
                                        <div class="d-flex justify-content-between align-items-center pt-3">
                                            <a href="{{ route('blog.post.detail', ['id' => $item->id, 'slug' => $item->post_slug]) }}"
                            ...
                            <div class="card-body">
                                ...
                                <ul class="generic-list-item">
                                    @foreach ($blogCategoryAll as $item)
                                        <li><a
                                                href="{{ route('blog.post.category.list', ['id' => $item->id]) }}">{{ $item->category_name }}</a>
                                        </li>
                                    @endforeach
                            ...
                            <div class="card-body">
                                ...
                                @foreach ($post as $item)
                                    <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                        <a href="{{ route('blog.post.detail', ['id' => $item->id, 'slug' => $item->post_slug]) }}"
                                            class="media-img">
                                            <img class="mr-3" src="{{ asset($item->post_image) }}"
