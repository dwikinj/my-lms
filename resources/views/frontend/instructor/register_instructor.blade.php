                            ...
                            <form method="post" action="{{route('instructor.register')}}" class="row">
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input class="@error('name') is-invalid @enderror form-control form--control"
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input class="@error('username') is-invalid @enderror form-control form--control"
                                            type="text" name="username" placeholder="e.g. smith21">
                                        <span class="la la-user input-icon"></span>
                                        @error('username')
                                            <span class="text-danger">{{ $message }} </span>
                                        @enderror
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input class="@error('phone') is-invalid @enderror form-control form--control"
                                            type="text" name="phone" placeholder="e.g. 08348888888">
                                ...
                                <div class="input-box col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <input class="@error('address') is-invalid @enderror form-control form--control"
                                            type="text" name="address" placeholder="e.g. St. Petenburh, Ca">
                                ...
                                <div class="input-box col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <input class="@error('password') is-invalid @enderror form-control form--control"
